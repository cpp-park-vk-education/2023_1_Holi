...
TEST(VKRequestTest, GmockTestRequestMakerCall) {
    ...
    auto response_ptr = std::make_unique<VKResponse>();
    VKRequest request(std::move(response_ptr)); //Добавить к аргументам requestMaker
