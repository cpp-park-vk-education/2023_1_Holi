...
#include "request_handling/video_all_route.h"


MessageInfo VideoAllRoute::Get(int id) {
    if (id <= 0) {
...
MessageInfo VideoAllRoute::Post(json::value body) {
    return {};
}

MessageInfo VideoAllRoute::Delete(int id) {
    return {};
}
