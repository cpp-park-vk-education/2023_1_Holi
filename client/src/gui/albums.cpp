...
Albums::Albums(QWidget *parent) : QWidget(parent), ui(new Ui::Albums) {
  ui->setupUi(this);
}

Albums::~Albums() { delete ui; }

void Albums::on_treeWidget_itemDoubleClicked(QTreeWidgetItem *item,
                                             int column) {
...
QString Albums::Test() { return "12345"; }
